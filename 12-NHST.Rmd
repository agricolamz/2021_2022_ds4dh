...
Некоторые тесты работают с предположениями об устройстве данных. В нашем случае данные предположения: нормальность распределения генеральной совокупности.
...
| нормальное ГС  | с заданным значением |    1    | одновыборочный t-test          |
| нормальное ГС  | независимые          |    2    | t-test для независимых выборок |
| нормальное     | зависимые            |    2    | парный t-test                  |
| не нормальное ГС | с заданным значением |    1    | критерий Уилкоксона            |
| не нормальное  ГС | независимые          |    2    | критерий Манна-Уитни           |
| не нормальное  ГС | зависимые            |    2    | критерий Уилкоксона            |
...
* нормальность распределения данных в генеральной совокупности 
* гомоскедостичность (гомогенность) дисперсии

### Тест Уилкоксона

Если есть основания полагать, что данные в генеральной совокупности не нормально распределено, обычно используют критерий Уилкоксона
...
Если есть основания полагать, что данные генеральной совокупности не распределены нормально, используют критерий Манна-Уитни (по английски его тоже называют Wilcoxon test).
